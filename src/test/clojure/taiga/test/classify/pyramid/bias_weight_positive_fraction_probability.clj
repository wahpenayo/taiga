...
;; mvn -Dtest=taiga.test.classify.pyramid.bias-weight-positive-fraction-probability clojure:test > tests.txt
;;------------------------------------------------------------------------------
(def nss (str *ns*))
(test/deftest pyramid-bias-weight-positive-fraction-probability
  ...
  (z/seconds 
    ...
    (let [bias 0.1
      ...
      (test/is (== (float train-mad) (float 0.021350609234480206)))
      (println "test" test-mad)
      (test/is (== (float test-mad) (float 0.02153268782560328)))
