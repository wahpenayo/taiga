\documentclass[11pt,openany,american,usenames,dvipsnames,svgnames,x11names,table,isodate]{article}
...
\usepackage{geometry}
\geometry{twoside,twocolumn,landscape,margin=2cm,columnsep=2cm,
paperheight=300mm,paperwidth=168mm}

\usepackage[unicode=true,pdfusetitle,
 bookmarks=true,bookmarksnumbered=false,bookmarksopen=true,bookmarksopenlevel=1,
 breaklinks=false,pdfborder={0 0 0},backref=false,colorlinks=true]{hyperref}
\hypersetup{unicode=true,colorlinks=true,pdfpagemode=UsfeOutlines,
pdfpagelayout=OneColumn,pdfstartview=FitH,linkcolor=MidnightBlue,
urlcolor=Mahogany,citecolor=OliveGreen}
\makeatletter
...
\titleformat{\subsection}{\headingfont\bfseries}{\thesubsection}{0.5em}{}
\titleformat{\subsubsection}{\headingfont\mdseries}{\thesubsubsection}{0.5em}{}
\titleformat{\paragraph}[runin]{\headingfont\mdseries}{\thesubsubsection}{0.5em}{}[\hspace{1em}]
...
\usepackage{enumitem}
\setlist[description]{font=\sffamily\mdseries,style=unboxed,leftmargin=0cm}
\setlist[itemize]{style=unboxed,leftmargin=0cm}
\setlist[enumerate]{style=unboxed,leftmargin=0cm}
