package taiga.java.split.numerical;
...
public final class XYW {
  ...
  // sorting
  //----------------------------------------------------------------------------
  private static final void swap (final XYW[] xys,                   
                                  final int i,
                                  final int j) {
    final XYW xyi = xys[i]; 
    xys[i] = xys[j]; 
  ...
  //----------------------------------------------------------------------------
  private static final int indexOfMedian (final XYW[] xys,
                                          final int i,
                                          final int j,
                                          final int k) {
    ...
    return i; }
  //----------------------------------------------------------------------------
  private static final void small (final XYW[] xys, 
                                   final int start, 
                                   final int length) {
    ...
    for (int i=start; i<end; i++) {
      ...
      for (int j=i;j > start;j--) {
        ...
        swap(xys,j,j-1); } } }
  //----------------------------------------------------------------------------
  private static final double initialPivot (final XYW[] xys, 
                                            final int start, 
                                            final int length) {
    ...
    return xys[i].x; }
  //---------------------------------------------------------------------------
  private static final void sort (final XYW[] xys, 
                                  final int start, 
                                  final int length) {
    final int end = start + length;
  ...
  //----------------------------------------------------------------------------
  public static final int notMissingX (final XYW[] xys) {
  ...
  //----------------------------------------------------------------------------
  public static final Object[] cacheXYW (final OD x, 
                                         final OD y, 
                                         final OD w, 
                                         final List data,
                                         final XYW[] xys) {
    ...
    for (int i=0;i<n;i++) {
      ...
      final double yi = y.invokePrim(di);
      final double wi = w.invokePrim(di);
      xys[i] = new XYW(xi,yi,wi); }
